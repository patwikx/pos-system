...
import { Plus, CalendarIcon, Calculator } from "lucide-react"
...
export const JournalEntryForm: React.FC<JournalEntryFormProps> = ({ accounts }) => {
  ...
  return (
    <>
      <div className="flex items-center justify-between">
        <Heading title="Create Journal Entry" description="Create a new manual journal entry" />
      </div>
      <Separator />
