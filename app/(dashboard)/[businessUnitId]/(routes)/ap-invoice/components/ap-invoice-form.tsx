...
type APInvoiceFormValues = z.infer<typeof formSchema>
...
export const APInvoiceForm: React.FC<APInvoiceFormProps> = ({ 
  vendors, 
  expenseAccounts 
}) => {
  ...
  const form = useForm<APInvoiceFormValues>({
  ...
  const onSubmit = async (data: APInvoiceFormValues) => {
    try {
      setLoading(true);
      await axios.post(`/api/${params.businessUnitId}/ap-invoice`, data);
      router.push(`/${params.businessUnitId}/ap-invoice`);
      toast.success('A/P Invoice created successfully.');
    } catch (error: any) {
  ...
  return (
    <>
      <div className="flex items-center justify-between">
        <Heading title="Create A/P Invoice" description="Create a new vendor bill" />
      </div>
      <Separator />
